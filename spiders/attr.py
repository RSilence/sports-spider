...
class AttrSpider(scrapy.Spider):
    name = 'attr'
    allowed_domains = ['https://list.tmall.com//search_product.htm?spm=a221t.1710954.8404982328.34.5d33287aN6woWs']
    start_urls = ['https://list.tmall.com//search_product.htm?spm=a221t.1710954.8404982328.34.5d33287aN6woWs&acm=lb-zebra-7771-282648.1003.8.421246&q=%C0%BA%C7%F2%D4%CB%B6%AF&tab=mall&type=p&scm=1003.8.lb-zebra-7771-282648.ITEM_14413206744903_421246']

    def parse(self, response):

        # 打开页面
        dr = webdriver.Chrome('D:\lectures\Python\pycharm\scrapy\chromedriver_win32\chromedriver.exe')
        url = 'https://list.tmall.com//search_product.htm?spm=a221t.1710954.8404982328.34.5d33287aN6woWs&acm=lb-zebra-7771-282648.1003.8.421246&q=%C0%BA%C7%F2%D4%CB%B6%AF&tab=mall&type=p&scm=1003.8.lb-zebra-7771-282648.ITEM_14413206744903_421246'
        page = dr.get(url)
